...
void GraphCase1(SDL_Renderer *renderer, TTF_Font *font, char function[], int x1, int y1, int x2, int y2, int increment, int divX, int xmin, int xmax, double maximum){
    ...
    for( int i = xmin+(2*increment); i <= xmax; i = i+increment ){
        crearTexto(renderer, font, color,"X", x1-5, y1-10);
        strcpy(aux, function);
        x1 = x2; 
        x2 = x1 + divX;
        y1 = y2; 
        ...
        SDL_RenderDrawLine(renderer, x1, y1, x2, y2 );
        crearTexto(renderer, font, color,"X", x2-5, y2-10);
    }
}
...
void cambiarMiContrasena(SDL_Renderer *renderer , TTF_Font *font ,SDL_Color white, char nombreUsario[]){
        ...
        char indicativo2[40]=" ";
        char contrasenaNueva[13]=" ";char contrasenaNuevaOculta[20]=" ";
        char indicativo3[40]= " ";
                ...
                if (event.type == SDL_QUIT ) {
                    ...
                    if ( userWriting==0){
                        ...
                        if (event.key.keysym.sym >= SDLK_a && event.key.keysym.sym <= SDLK_z){
                            ...
                            RellenarCadena( contrasenaNueva, sizeof ( contrasenaNueva) );
                            RellenarCadena( contrasenaNuevaConfirmacion, sizeof ( contrasenaNuevaConfirmacion) );
...
void MisGraficas(SDL_Renderer *renderer , TTF_Font *font ,SDL_Color white, char name[]){
    ...
    char sort[] = "Ordenar por fecha. Presione(1) Orden ascendente (2) Orden Descendente: ";//texto que muestra la eleccion de ordenamiento
    ...
    if ( k !=-1){
        ...
        while (!quit) {
            ...
            crearTexto(renderer ,font,white,title, 20, y);y+=20;
            crearTexto(renderer ,font,white,subtitle, 20, y);y+=20;
            crearTexto(renderer ,font,white,sort, 20, y);y+=20;
